// World-domain scripting primitives: cross-component queries plus the
// runtime gravity register read/write pair.
...
// --- worldQuery ------------------------------------------------------------
//
// Generic ECS query primitive that spans multiple component domains (light,
// transform, emitter, fog volume). Per-domain helpers continue to live in
// their sibling primitive modules; this file owns the dispatch.
