...
pub struct DescriptorRefreshPlan {
    pub actions: Vec<DescriptorRefreshAction>,
    pub diagnostics: Vec<DescriptorRefreshDiagnostic>,
}
...
#[derive(Debug, Clone, PartialEq)]
pub enum DescriptorRefreshAction {
    Replace {
        entity: EntityId,
...
pub struct DescriptorRefreshDiagnostic {
    pub entity: EntityId,
    pub descriptor: String,
    pub component: Option<DescriptorComponentKind>,
    pub message: String,
}
...
pub enum DescriptorRefreshApplyError {
...
pub fn plan_descriptor_refresh(
...
pub fn apply_descriptor_refresh_plan(
...
mod tests {
    ...
    fn movement_refresh_rebinds_edited_dash_expression() {
        ...
        use crate::data_descriptors::NumberOrIr;
    ...
    fn mesh_descriptor_refresh_declines_and_keeps_live_animation_state() {
        ...
        use crate::components::mesh::{AnimationState, FadeSourceKind, MeshAnimation};
        use crate::data_descriptors::MeshDescriptor;
        use std::collections::HashMap;
