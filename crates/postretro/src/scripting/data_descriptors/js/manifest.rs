...
pub(crate) fn registered_ui_tree_from_js<'js>(
    ctx: &Ctx<'js>,
    value: JsValue<'js>,
...
pub(crate) fn frontend_from_js<'js>(obj: &Object<'js>) -> Result<Frontend, DescriptorError> {
...
pub(crate) fn menu_camera_from_js<'js>(obj: &Object<'js>) -> Result<MenuCamera, DescriptorError> {
...
pub(crate) fn optional_manifest_array_js<'js>(
    obj: &Object<'js>,
    field: &'static str,
    scope: &str,
...
pub(crate) fn mod_map_entry_from_js<'js>(
    value: JsValue<'js>,
...
pub(crate) fn push_valid_map_entry(
    entry: ModMapEntry,
...
pub(crate) fn string_map_from_js<'js>(
    obj: &Object<'js>,
    field: &'static str,
...
/// are logged and skipped (per-token degraded) so a single bad entry does not
/// abort the whole theme drain — mirrors the Luau twin.
pub(crate) fn f32_map_from_js<'js>(
    obj: &Object<'js>,
    field: &'static str,
...
pub(crate) fn f32_array4_map_from_js<'js>(
    obj: &Object<'js>,
    field: &'static str,
