...
pub(crate) fn registered_ui_tree_from_lua(
    value: LuaValue,
...
pub(crate) fn frontend_from_lua(table: &Table) -> Result<Frontend, DescriptorError> {
...
pub(crate) fn menu_camera_from_lua(table: &Table) -> Result<MenuCamera, DescriptorError> {
...
pub(crate) fn optional_manifest_array_lua(
    table: &Table,
    field: &'static str,
    scope: &str,
...
pub(crate) fn mod_map_entry_from_lua(value: LuaValue) -> Result<ModMapEntry, DescriptorError> {
