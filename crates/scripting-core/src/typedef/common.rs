...
pub fn rust_to_ts(ty_name: &str) -> String {
    ...
    match short.as_str() {
        ...
        "ParticleState" => "ParticleState".to_string(),
        "SpriteVisual" => "SpriteVisual".to_string(),
        ...
        "ProjectileDescriptor" => "ProjectileDescriptor".to_string(),
        "ProjectileVisual" => "ProjectileVisual".to_string(),
        "ProjectileLight" => "ProjectileLight".to_string(),
        "ProjectileBodyVisual" => "ProjectileBodyVisual".to_string(),
        "ProjectileSpriteBodyVisual" => "ProjectileSpriteBodyVisual".to_string(),
        "ProjectileModelBodyVisual" => "ProjectileModelBodyVisual".to_string(),
        "ProjectileTrailVisual" => "ProjectileTrailVisual".to_string(),
        "ProjectileTrailSpinAnimation" => "ProjectileTrailSpinAnimation".to_string(),
        "PlayerMovementDescriptor" => "PlayerMovementDescriptor".to_string(),
        "KnockbackDescriptor" => "KnockbackDescriptor".to_string(),
        "SplashKnockbackDescriptor" => "SplashKnockbackDescriptor".to_string(),
        "KnockbackResponse" => "KnockbackResponse".to_string(),
        ...
        "SlideParams" => "SlideParams".to_string(),
