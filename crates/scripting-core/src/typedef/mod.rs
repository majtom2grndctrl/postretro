...
pub fn write_type_definitions(registry: &PrimitiveRegistry, out_dir: &Path) -> io::Result<()> {
...
pub fn emit_sdk_types_in_debug(registry: &PrimitiveRegistry) {
...
pub fn emit_sdk_types_in_debug(_registry: &PrimitiveRegistry) {}
