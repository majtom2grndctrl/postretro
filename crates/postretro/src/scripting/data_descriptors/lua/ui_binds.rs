...
pub(crate) fn lua_table(value: LuaValue, what: &str) -> Result<Table, DescriptorError> {
    match value {
...
pub(crate) fn read_f32_pair_lua(
    table: &Table,
    field: &'static str,
...
pub(crate) fn read_f32_array_n_lua<const N: usize>(
    value: LuaValue,
    field: &str,
...
pub(crate) fn lua_value_as_f32(value: LuaValue, field: &str) -> Result<f32, DescriptorError> {
    match value {
...
pub(crate) fn get_optional_string_lua(
    table: &Table,
    field: &'static str,
...
pub(crate) fn color_value_from_lua(
    table: &Table,
    field: &'static str,
...
pub(crate) fn color_value_opt_from_lua(
    table: &Table,
    field: &'static str,
...
pub(crate) fn color_value_from_lua_value(
    value: LuaValue,
    field: &str,
) -> Result<ColorValue, DescriptorError> {
    match value {
...
pub(crate) fn spacing_value_from_lua(
    table: &Table,
    field: &'static str,
...
pub(crate) fn focus_neighbors_from_lua(table: &Table) -> Result<FocusNeighbors, DescriptorError> {
...
pub(crate) fn focus_policy_from_lua(table: &Table) -> Result<Option<FocusPolicy>, DescriptorError> {
...
pub(crate) fn repeat_policy_opt_from_lua(
    table: &Table,
    field: &'static str,
...
pub(crate) fn string_array_from_lua(
    table: &Table,
    field: &'static str,
...
pub(crate) fn text_bind_from_lua(table: &Table) -> Result<Option<TextBind>, DescriptorError> {
...
pub(crate) fn panel_bind_from_lua(table: &Table) -> Result<Option<PanelBind>, DescriptorError> {
    let Some(bind) = optional_table_lua(table, "bind")? else {
        return Ok(None);
    };
    Ok(Some(PanelBind {
...
pub(crate) fn slider_bind_from_lua(
    table: &Table,
    field: &'static str,
...
pub(crate) fn bind_source_from_lua(bind: &Table) -> Result<BindSource, DescriptorError> {
...
pub(crate) fn bar_max_from_lua(table: &Table) -> Result<BarMax, DescriptorError> {
...
pub(crate) fn predicate_opt_from_lua(
    table: &Table,
    field: &'static str,
...
pub(crate) fn predicate_value_opt_from_lua(
    table: &Table,
    field: &str,
...
pub(crate) fn role_opt_from_lua(table: &Table) -> Result<Option<Role>, DescriptorError> {
...
pub(crate) fn text_tween_from_lua(table: &Table) -> Result<Option<TextTween>, DescriptorError> {
...
pub(crate) fn panel_tween_from_lua(table: &Table) -> Result<Option<PanelTween>, DescriptorError> {
    let Some(tw) = optional_table_lua(table, "tween")? else {
        return Ok(None);
    };
...
pub(crate) fn style_ranges_from_lua(table: &Table) -> Result<Option<StyleRanges>, DescriptorError> {
...
pub(crate) fn optional_table_lua(
    table: &Table,
    field: &'static str,
