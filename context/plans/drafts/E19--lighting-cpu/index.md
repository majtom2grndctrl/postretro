...
## Sequencing
**Phase 1:** Task 1, then Task 2 (placement confirmation). Largely independent; needs `postretro-render-data` (`E19--render-data`) only if `cone_frustum` references geometry types. Milestone 2.
