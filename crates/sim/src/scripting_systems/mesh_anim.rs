...
impl ModelClipTable {
    ...
    pub fn from_metadata(meta: &[postretro_model::ClipMetadata]) -> Self {
    ...
    pub fn duration(&self, index: usize) -> Option<f32> {
...
impl MeshClipTables {
    ...
    pub fn get(&self, handle: &ModelHandle) -> Option<&ModelClipTable> {
    ...
    pub fn model_bounds(&self, handle: &ModelHandle) -> Aabb {
...
pub fn animate_entity(anim: &MeshAnimation, anim_time: f64, phase: f32) -> Option<AnimResult> {
