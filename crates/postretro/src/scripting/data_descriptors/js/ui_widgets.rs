...
pub(crate) fn widget_from_js<'js>(
    ctx: &Ctx<'js>,
    value: JsValue<'js>,
) -> Result<Widget, DescriptorError> {
    let obj = Object::from_value(value).map_err(|_| DescriptorError::InvalidShape {
...
pub(crate) fn text_widget_from_js<'js>(
    ctx: &Ctx<'js>,
    obj: &Object<'js>,
...
pub(crate) fn panel_widget_from_js<'js>(
    ctx: &Ctx<'js>,
    obj: &Object<'js>,
...
pub(crate) fn image_widget_from_js<'js>(obj: &Object<'js>) -> Result<ImageWidget, DescriptorError> {
...
pub(crate) fn container_widget_from_js<'js>(
    ctx: &Ctx<'js>,
    obj: &Object<'js>,
...
pub(crate) fn local_state_from_js<'js>(
    obj: &Object<'js>,
) -> Result<Option<LocalState>, DescriptorError> {
...
pub(crate) fn cell_init_from_js(value: JsValue) -> Result<CellInit, DescriptorError> {
...
pub(crate) fn grid_widget_from_js<'js>(
    ctx: &Ctx<'js>,
    obj: &Object<'js>,
...
pub(crate) fn spacer_widget_from_js<'js>(
    obj: &Object<'js>,
) -> Result<SpacerWidget, DescriptorError> {
    Ok(SpacerWidget {
...
pub(crate) fn button_widget_from_js<'js>(
    ctx: &Ctx<'js>,
    obj: &Object<'js>,
...
pub(crate) fn slider_widget_from_js<'js>(
    ctx: &Ctx<'js>,
    obj: &Object<'js>,
...
pub(crate) fn bar_widget_from_js<'js>(
    ctx: &Ctx<'js>,
    obj: &Object<'js>,
...
pub(crate) fn announce_widget_from_js<'js>(
    obj: &Object<'js>,
) -> Result<AnnounceWidget, DescriptorError> {
...
pub(crate) fn children_from_js<'js>(
    ctx: &Ctx<'js>,
    obj: &Object<'js>,
