...
| Ammo enters a reserve *after spawn* through exactly one function | Task 1 | Task 3 and any future pickup/loot spec must call it rather than credit directly; descriptor spawn seeding in `seed_weapon_reserve` is the one deliberate second write path | AC 17 |
