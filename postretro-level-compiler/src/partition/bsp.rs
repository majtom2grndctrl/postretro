...
///
/// Sign convention: `dot(point, node.plane_normal) - node.plane_distance >= 0.0`
/// descends to the front child; negative descends to the back child. (Zero goes
/// to the front side, matching how faces lying on a splitting plane are placed.)
