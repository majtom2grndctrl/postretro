...
pub struct StagedManifestBuildLane {
...
impl StagedManifestBuildLane {
    ...
    #[cfg(test)]
    pub fn new_for_test_latest(generation: u64) -> Self {
    ...
    pub fn poll_completed(&mut self) -> Vec<StagedManifestBuildResult> {
