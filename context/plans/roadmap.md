...
- [ ] **Navigation foundation** — pathfinding against the Milestone 7 trimesh collider. The heavy, uncertain plan, isolated. Smallest workable primitive: move toward a target without clipping. Richer queries (line-of-sight, patrol paths) deferred. Depends on the entity health/damage surface.
