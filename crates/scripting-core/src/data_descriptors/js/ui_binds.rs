...
pub fn read_f32_array_n_js<'js, const N: usize>(
    value: &JsValue<'js>,
    field: &str,
...
pub fn js_value_as_f32(value: &JsValue, field: &str) -> Result<f32, DescriptorError> {
...
pub fn get_optional_string_js<'js>(
    obj: &Object<'js>,
    field: &'static str,
...
pub fn color_value_opt_from_js<'js>(
    obj: &Object<'js>,
    field: &'static str,
...
pub fn color_value_from_js_value(
    value: &JsValue,
    field: &str,
) -> Result<ColorValue, DescriptorError> {
...
pub fn spacing_value_from_js<'js>(
    obj: &Object<'js>,
    field: &'static str,
...
pub fn focus_neighbors_from_js<'js>(obj: &Object<'js>) -> Result<FocusNeighbors, DescriptorError> {
...
pub fn focus_policy_from_js<'js>(
    obj: &Object<'js>,
...
pub fn repeat_policy_opt_from_js<'js>(
    obj: &Object<'js>,
    field: &'static str,
...
pub fn string_array_from_js<'js>(
    obj: &Object<'js>,
    field: &'static str,
...
pub fn bar_max_from_js<'js>(obj: &Object<'js>) -> Result<BarMax, DescriptorError> {
...
pub fn finite_bar_max_literal(value: f64) -> Result<BarMax, DescriptorError> {
...
pub fn validate_bar_max_slot(slot: String) -> Result<String, DescriptorError> {
    if slot.is_empty() {
        return Err(DescriptorError::InvalidShape {
...
pub fn predicate_opt_from_js<'js>(
    obj: &Object<'js>,
    field: &'static str,
...
pub fn predicate_value_opt_from_js<'js>(
    obj: &Object<'js>,
    field: &str,
...
pub fn role_opt_from_js<'js>(obj: &Object<'js>) -> Result<Option<Role>, DescriptorError> {
...
pub fn panel_tween_from_js<'js>(obj: &Object<'js>) -> Result<Option<PanelTween>, DescriptorError> {
    let Some(tw) = optional_object_js(obj, "tween")? else {
        return Ok(None);
    };
...
pub fn style_ranges_from_js<'js>(
    _ctx: &Ctx<'js>,
    obj: &Object<'js>,
