...
sequenceDiagram
    ...
    loop warmup then samples
        ...
        Renderer->>Timing: write/resolve existing pass timestamps
        Renderer->>Renderer: submit and complete by named cadence
...
submission drives `FrameTiming::post_submit`.
...
`renderer_render_frame.rs` about 1,100, and `render/sh_volume.rs` about 1,200. The brief
