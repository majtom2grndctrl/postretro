...
use crate::data_descriptors::LevelManifest;
use crate::error::ScriptError;
use crate::primitives_registry::ScriptPrimitive;
use crate::quickjs::{QuickJsSubsystem, run_script};
#[cfg(debug_assertions)]
use crate::refresh_plan::{DescriptorRefreshAction, DescriptorRefreshPlan};
...
pub(super) fn follow_pawn_health_range_after_refresh(
    ...
    slot_table: &mut crate::slot_table::SlotTable,
) {
    use crate::components::health::pawn_with_health;
    use crate::registry::ComponentValue;
    use crate::slot_table::NumericRange;
