...
What this buys: a filled schema is checkable in a way a paragraph is not, and prose written against it cannot drift from it without the drift being visible.
