...
#[cfg(feature = "dev-tools")]
fn collect_agent_overlay_snapshots_for_view(
    registry: &postretro_entities::EntityRegistry,
...
#[cfg(feature = "dev-tools")]
fn agent_overlay_diagnostics_rows(
...
#[cfg(feature = "dev-tools")]
fn paint_agent_overlay_labels(ctx: &egui::Context, labels: &[AgentOverlayLabel]) {
...
#[cfg(feature = "dev-tools")]
fn emit_agent_overlay_geometry(renderer: &mut Renderer, agents: &[AgentOverlayGeometry]) {
                ...
                if let Some(renderer) = self.renderer.as_mut() {
                    ...
                    let (agent_overlay_geometry, agent_overlay_labels) = {
                        ...
                        if include_geometry || include_labels {
                            ...
                            collect_agent_overlay_snapshots_for_view(
                                &registry,
                                view_proj,
                    ...
                    #[cfg(feature = "dev-tools")]
                    let agent_rows = agent_overlay_diagnostics_rows(&agent_overlay_labels);
                    ...
                    let debug_ui_frame: Option<(
                            ...
                            if diagnostics_visible || paint_agent_labels {
                                ...
                                let full_output = ctx_clone.run_ui(raw_input, |ui| {
                                    ...
                                    if paint_agent_labels {
                                        paint_agent_overlay_labels(ctx, &agent_overlay_labels);
                                    }
                        ...
                        // debug-line surfaces.
                        emit_agent_overlay_geometry(renderer, &agent_overlay_geometry);
...
mod tests {
    ...
    fn agent_overlay_projection_maps_in_front_point_inside_viewport() {
        let render_camera =
            camera::RenderCamera::new(Vec3::ZERO, 4.0 / 3.0, 0.0, 0.0, 0.0, Vec3::ZERO);
