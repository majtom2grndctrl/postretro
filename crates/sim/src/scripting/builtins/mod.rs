...
pub use data_archetype::apply_data_archetype_dispatch;
#[allow(unused_imports)]
pub use data_archetype::{
...
pub use crate::scripting::map_entity::MapEntity;
...
impl ClassnameDispatch {
    ...
    /// condition.
    pub fn register(&mut self, classname: &'static str, handler: ClassnameHandler) {
    ...
    pub fn lookup(&self, classname: &str) -> Option<ClassnameHandler> {
...
/// map entities.
pub fn register_builtins(dispatch: &mut ClassnameDispatch) {
    dispatch.register(
...
pub fn apply_classname_dispatch(
    entities: &[MapEntity],
