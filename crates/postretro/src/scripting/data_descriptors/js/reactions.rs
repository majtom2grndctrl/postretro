...
pub(crate) fn named_reaction_from_js<'js>(
    ctx: &Ctx<'js>,
    value: JsValue<'js>,
...
pub(crate) fn progress_descriptor_from_js<'js>(
    _ctx: &Ctx<'js>,
    obj: &Object<'js>,
...
pub(crate) fn crossing_descriptor_from_js<'js>(
    value: &JsValue<'js>,
...
pub(crate) fn primitive_descriptor_from_js<'js>(
    ctx: &Ctx<'js>,
    obj: &Object<'js>,
...
pub(crate) fn sequence_steps_from_js<'js>(
    ctx: &Ctx<'js>,
    arr: &Array<'js>,
...
pub(crate) fn get_required_u32_js<'js>(
    obj: &Object<'js>,
    field: &'static str,
