...
pub fn ai_capsule_center_from_feet_offset(
...
pub fn descriptor_materializes_ai_enemy(descriptor: &EntityTypeDescriptor) -> bool {
...
pub fn descriptor_materializes_world_item(descriptor: &EntityTypeDescriptor) -> bool {
    descriptor.touchable.is_some()
}
...
pub fn filter_out_client_host_replicated_placements(
    entities: &[MapEntity],
...
pub fn suppressed_client_host_replicated_mesh_models(
    entities: &[MapEntity],
    descriptors: &[EntityTypeDescriptor],
) -> Vec<String> {
...
pub fn movement_descriptor_mesh_models(descriptors: &[EntityTypeDescriptor]) -> Vec<String> {
    let mut seen = HashSet::new();
    let mut ordered = Vec::new();
...
pub fn weapon_presentation_models(descriptors: &[EntityTypeDescriptor]) -> Vec<String> {
    let mut seen = HashSet::new();
    let mut ordered = Vec::new();
    for descriptor in descriptors {
...
pub struct ProjectileSpriteCollection {
...
pub fn projectile_presentation_assets(
    descriptors: &[EntityTypeDescriptor],
...
pub fn touchable_wieldable_world_models(descriptors: &[EntityTypeDescriptor]) -> Vec<String> {
    let mut seen = HashSet::new();
    let mut ordered = Vec::new();
    for descriptor in descriptors {
...
/// per sweep.
pub fn apply_data_archetype_dispatch(
    entities: &[MapEntity],
    descriptors: &[EntityTypeDescriptor],
...
pub const PLAYER_START_CLASSNAME: &str = "player_spawn";
...
pub fn spawn_from_player_starts_with_carried_loadout(
    spawn_points: &[MapEntity],
    descriptors: &[EntityTypeDescriptor],
    registry: &mut EntityRegistry,
    agent_params: Option<NavAgentParams>,
