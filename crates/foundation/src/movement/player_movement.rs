...
pub struct DashPrograms {
    pub boost_speed: Option<BoundProgram<MovementScope>>,
    pub momentum_retention: Option<BoundProgram<MovementScope>>,
    pub steer_control: Option<BoundProgram<MovementScope>>,
    pub dash_drag: Option<BoundProgram<MovementScope>>,
    pub cooldown_ms: Option<BoundProgram<MovementScope>>,
    pub preserve_vertical: Option<BoundProgram<MovementScope>>,
}
...
pub struct PlayerMovementComponent {
    ...
    #[serde(skip)]
    pub dash_programs: DashPrograms,
...
impl PlayerMovementComponent {
    ...
    pub fn from_descriptor(desc: &PlayerMovementDescriptor) -> Self {
    ...
    pub fn refresh_on_landing(&mut self) {
