...
- All registration, lifecycle, and engine-side runtime work: manifest arms, the tiered tree registry, the always-on compose mechanism, theme/font script registration, `ui.localState()`. → **G1b**.
