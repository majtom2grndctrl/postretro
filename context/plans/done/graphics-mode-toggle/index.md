...
- **Aniso clamp value.** 16 is the wgpu ceiling and the quality default. **Resolved (Task 6):** measured on the owner's hardware, forward-pass cost was effectively equal between modes at 1080p on campaign-test at grazing angles — well under the 15% threshold — so `POST_RETRO_ANISO_CLAMP` stays at 16.
