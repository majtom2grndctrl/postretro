...
- [ ] `--cache-dir <PATH>` redirects all layer/group reads and writes under the override; entries land there, not in the default `.build-caches/prl-cache/`.
