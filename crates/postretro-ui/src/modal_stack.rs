...
impl ModalStack {
    ...
    pub fn registry_mut(&mut self) -> &mut UiTreeRegistry {
        &mut self.registry
    }
    ...
    pub fn replace_script_tree_tier(
        &mut self,
        trees: impl IntoIterator<Item = RegisteredUiTree>,
        tier: ScopeTier,
    ) {
    ...
    pub fn clear_script_tree_tier(&mut self, tier: ScopeTier) {
        self.registry
    ...
    pub fn always_on_layers(&self) -> Vec<UiTreeEntry> {
    ...
    pub fn replace_with_frontend_menu(
        &mut self,
        preferred_name: &str,
        fallback_name: &str,
    ) -> Option<String> {
    ...
    pub fn top_capture_mode(&self) -> CaptureMode {
        self.stack
            .last()
    ...
    pub fn active_text_entry_target(&self) -> Option<&str> {
        self.stack
            .last()
    ...
    pub fn active_on_commit(&self) -> Option<&str> {
...
mod tests {
    ...
    use crate::descriptor::{Align, CaptureMode, ContainerWidget, SpacingValue, Widget};
    ...
    fn replace_with_frontend_menu_uses_fallback_and_clears_old_stack() {
        ...
        register_pushable(&mut stack, crate::demo::FRONTEND_MENU_NAME, passthrough());
        stack.push_named("deathScreen", None);

        let resolved =
            stack.replace_with_frontend_menu("missingMenu", crate::demo::FRONTEND_MENU_NAME);

        assert_eq!(resolved.as_deref(), Some(crate::demo::FRONTEND_MENU_NAME),);
        assert_eq!(stack.len(), 1, "frontend presentation replaces the stack");
        assert_eq!(stack.active_name(), Some(crate::demo::FRONTEND_MENU_NAME),);
    ...
    fn replacing_mod_tier_with_omission_reveals_engine_frontend_fallback() {
        ...
        assert_eq!(
            stack.registry.tier_of(crate::demo::FRONTEND_MENU_NAME),
            Some(ScopeTier::Mod),
        ...
        assert!(
            stack.tree(crate::demo::FRONTEND_MENU_NAME).is_some(),
