...
name: create-skill
description: >
  Creates a new Codex skill for this project. Guides the user through
...
- Only include context Codex doesn't already have. Challenge every line: "Does Codex really need this?"
