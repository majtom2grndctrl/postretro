...
pub fn clear_owner_feedback_for_weapons(registry: &mut EntityRegistry, ids: &[EntityId]) {
...
pub fn clear_feedback_for_weapon(registry: &mut EntityRegistry, id: EntityId) {
