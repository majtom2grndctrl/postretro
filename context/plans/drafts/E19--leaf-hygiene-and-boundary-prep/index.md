...
- Widen `Frustum` and `FrustumPlane` (`visibility.rs:117`,`:128`) from `pub(crate)` to `pub` (needed across the `E19--visibility` crate boundary).
...
## Sequencing
**Phase 1:** Tasks 1–3 are independent; fan out. Milestone 1, alongside `E19--baseline-and-cargo-config`.
