...
use crate::scripting::primitives_registry::{RegisteredType, TaggedVariant, TypeShape};
...
fn emit_ts_game_state_node(
    ...
    catalog: &[crate::scripting::engine_state_catalog::EngineStateCatalogEntry<'static>],
    indent: &str,
    out: &mut String,
) {
    match node {
