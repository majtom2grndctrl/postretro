...
pub(crate) fn movement_descriptor_from_js<'js>(
    ctx: &Ctx<'js>,
    obj: &Object<'js>,
...
pub(crate) fn view_feel_params_from_js<'js>(
    obj: &Object<'js>,
) -> Result<ViewFeelParams, DescriptorError> {
...
pub(crate) fn bob_params_from_js<'js>(obj: &Object<'js>) -> Result<BobParams, DescriptorError> {
...
pub(crate) fn tilt_params_from_js<'js>(obj: &Object<'js>) -> Result<TiltParams, DescriptorError> {
...
pub(crate) fn sway_params_from_js<'js>(obj: &Object<'js>) -> Result<SwayParams, DescriptorError> {
...
pub(crate) fn forgiveness_params_from_js<'js>(
    obj: &Object<'js>,
...
pub(crate) fn dash_params_from_js<'js>(
    ctx: &Ctx<'js>,
    obj: &Object<'js>,
...
pub(crate) fn read_dash_number_js<'js>(
    ctx: &Ctx<'js>,
    obj: &Object<'js>,
    field: &'static str,
    path: &str,
...
pub(crate) fn read_dash_bool_js<'js>(
    ctx: &Ctx<'js>,
    obj: &Object<'js>,
    field: &'static str,
...
pub(crate) fn crouch_params_from_js<'js>(
    obj: &Object<'js>,
    radius: f32,
...
pub(crate) fn get_required_object_js<'js>(
    obj: &Object<'js>,
    field: &'static str,
...
pub(crate) fn get_required_bool_js<'js>(
    obj: &Object<'js>,
    field: &'static str,
