...
pub(crate) fn register_shared_types(registry: &mut PrimitiveRegistry) {
    ...
    registry
        ...
        .field("bloomPerShotDegrees?", "f32", "Sustained-fire bloom added after each resolved shot, in degrees. Range: 0..=45; defaults to 0.")
        .field("bloomMaxDegrees?", "f32", "Maximum sustained-fire bloom above base spread, in degrees. Range: 0..=45; defaults to 0.")
        .field("bloomDecayDegreesPerSecond?", "f32", "Rate at which sustained-fire bloom decays after its delay, in degrees per second. Must be finite and >= 0; defaults to 0.")
        .field("bloomDecayDelayMs?", "f32", "Idle delay before sustained-fire bloom begins to decay, in milliseconds. Must be finite and >= 0; defaults to 0.")
        .field("movementSpreadDegrees?", "f32", "Maximum movement-derived spread at authored run speed, in degrees. Range: 0..=45; defaults to 0.")
        .field("spreadVerticalBias?", "f32", "Upward tilt applied to the dynamic spread cone axis. Range: 0..=1; defaults to 0 (no tilt).")
