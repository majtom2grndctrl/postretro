...
## Sequencing
**Phase 1:** Task 1, then Task 2, then Task 3. Needs all the Milestone 1–2 CPU specs — `E19--render-data`, `E19--level-loader`, `E19--visibility`, `E19--lighting-cpu`, `E19--ui`, `E19--render-cpu`, plus `postretro-model` (`E19--model`). Milestone 3 (terminal). The full verification gate (invariant `rg`, `cargo tree` isolation across all crates, acyclicity, typedef drift, WGSL) runs here.
