...
pub use postretro_scripting_core::reaction_registry::ReactionPrimitiveRegistry;

pub fn register_emitter_reaction_primitives(registry: &mut ReactionPrimitiveRegistry) {
...
pub use crate::fx::fog_reactions::{
