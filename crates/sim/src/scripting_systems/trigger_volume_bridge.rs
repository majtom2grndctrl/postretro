...
pub struct TriggerVolumeBridge {
...
impl TriggerVolumeBridge {
    ...
    pub fn aabb(&self, id: EntityId) -> Option<(Vec3, Vec3)> {
        self.aabbs.get(&id).copied()
    }
    pub fn authored_order(&self, id: EntityId) -> Option<usize> {
    ...
    pub fn stable_order(&self, a: EntityId, b: EntityId) -> Ordering {
