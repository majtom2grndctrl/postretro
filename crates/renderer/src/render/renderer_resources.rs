...
impl Renderer {
    ...
    /// smoke pass owns its baked-sidecar attempt and PNG-decode fallback. Duplicate
    /// calls are reported and rejected rather than silently overriding an accepted
    /// descriptor's cadence or emissive strength.
