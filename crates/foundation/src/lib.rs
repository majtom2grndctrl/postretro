...
pub use brain::{
    ...
    BRAIN_DISTANCE_FROM_ANCHOR_INPUT, BRAIN_DISTANCE_TO_LAST_KNOWN_INPUT, BRAIN_HAS_TARGET_INPUT,
    ...
    BRAIN_TIME_SINCE_DAMAGE_MS_INPUT, BRAIN_TIME_SINCE_TARGET_VISIBLE_INPUT, BrainInputRef,
    BrainValidationScope, bind_brain_guard, resolve_brain_input,
};
pub use candidate::{
