...
pub struct ImpactPolicyRuntime {
    ctx: ScriptCtx,
...
pub struct DamagedEnemyOverlayDamage {
    pub entity: EntityId,
...
pub struct DamagedEnemyOverlayFact {
    pub entity: EntityId,
...
pub struct DamagedEnemyOverlayFrame {
    pub damage: Vec<DamagedEnemyOverlayDamage>,
    pub facts: Vec<DamagedEnemyOverlayFact>,
}
...
#[derive(Clone)]
pub struct ClientOverlayConfig {
    pub template: PresentationTemplateHandle,
    pub world_anchor: PresentationWorldAnchor,
...
impl ImpactPolicyRuntime {
    ...
    pub fn set_mod_id(&mut self, mod_id: Option<String>) {
    ...
    pub fn replace_global_events(&mut self, events: Vec<ImpactEventDescriptor>) {
    ...
    pub fn presentation_templates(&self) -> Vec<PresentationTemplate> {
    ...
    pub fn presentation_template_registry(&self) -> &HashMap<String, PresentationTemplate> {
    ...
    pub fn client_overlay_config(&self) -> Option<ClientOverlayConfig> {
    ...
    pub fn replace_presentation_overlays(&mut self, overlays: Vec<PresentationOverlay>) {
    ...
    pub fn clear_level_events(&mut self) {
    ...
    pub fn evaluate_pending_in_registry(
        &mut self,
    ...
    pub fn discard_app_drain_pending(&mut self) {
    ...
    pub fn update_damaged_enemy_overlays(
        &mut self,
...
mod tests {
    ...
    fn p12_fixed_tick_seam_reads_post_damage_engine_health() {
        ...
        publisher.publish_health_from_registry(&registry);
