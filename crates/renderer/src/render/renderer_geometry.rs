...
pub fn level_world_to_geometry<'a>(
    ...
    let sh_storage = match world.sh_stream_manifest() {
        Some(manifest) => LevelGeometryShStorage::Streaming(manifest),
        None => LevelGeometryShStorage::Legacy,
    };
    LevelGeometry {
        ...
        delta_sh_volumes: world.delta_sh_volumes(),
        direct_sh_volume: world.direct_sh_volume(),
        direct_sh_delta_volumes: world.direct_sh_delta_volumes(),
        animated_direct_sh_delta_volumes: world.animated_direct_sh_delta_volumes(),
        billboard_direct_scatter_volume: world.billboard_direct_scatter_volume(),
        animated_billboard_direct_scatter_delta_volumes: world
            .animated_billboard_direct_scatter_delta_volumes(),
        entity_shadow_lights: world.entity_shadow_lights(),
        shadowmask_atlas: world.shadowmask_atlas(),
