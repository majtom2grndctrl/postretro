...
Pin each cross-task invariant once. `orchestrate` hands this table to every task agent alongside the shared context and AC list — reference rows from task paragraphs instead of restating.
