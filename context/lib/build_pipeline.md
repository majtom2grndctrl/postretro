...
| KinematicGeometry | 43 | Version 5 when the map has at least one `kinematic_mover`; origin-relative mover vertices/indices/face metadata, static spin/blocking authoring, closed-mover portal associations, and `kinematic_waypoint` records |
