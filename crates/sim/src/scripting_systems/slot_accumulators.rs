...
#[derive(Default)]
pub struct SlotAccumulatorBindings {
...
impl SlotAccumulatorBindings {
    ...
    pub fn rebuild(&mut self, script_ctx: &ScriptCtx) {
        self.clear();
...
pub fn evaluate_slot_accumulators(bindings: &mut SlotAccumulatorBindings, tick_dt: f32) {
