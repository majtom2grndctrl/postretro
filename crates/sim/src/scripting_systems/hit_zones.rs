...
pub enum ModelLoadWarningOwner {
...
pub struct ModelHitZones {
    ...
    pub pose_stack: Arc<PoseModifierStack>,
}
...
impl HitZoneStore {
    ...
    pub fn get(&self, handle: &ModelHandle) -> Option<&ModelHitZones> {
    ...
    /// animated entity.
    pub fn get_by_name(&self, model: &str) -> Option<&ModelHitZones> {
    ...
    pub fn has_precise_zones(&self, handle: &ModelHandle) -> bool {
        self.models
            .get(handle.as_str())
    ...
    pub fn has_pose_modifiers(&self, handle: &ModelHandle) -> bool {
...
/// returned tag.
pub fn unknown_zone_multiplier_tags<'a>(
...
/// renderer do.
pub fn model_matrix(transform: &Transform, origin_offset: Vec3) -> Option<Mat4> {
