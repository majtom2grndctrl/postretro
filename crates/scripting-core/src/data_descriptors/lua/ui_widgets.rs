...
pub fn anchored_tree_from_lua_value(value: LuaValue) -> Result<AnchoredTree, DescriptorError> {
...
pub fn widget_from_lua(value: LuaValue) -> Result<Widget, DescriptorError> {
...
pub fn text_widget_from_lua(table: &Table) -> Result<TextWidget, DescriptorError> {
    Ok(TextWidget {
...
pub fn panel_widget_from_lua(table: &Table) -> Result<PanelWidget, DescriptorError> {
    Ok(PanelWidget {
...
pub fn image_widget_from_lua(table: &Table) -> Result<ImageWidget, DescriptorError> {
...
pub fn local_state_from_lua(table: &Table) -> Result<Option<LocalState>, DescriptorError> {
...
pub fn cell_init_from_lua(value: LuaValue) -> Result<CellInit, DescriptorError> {
    match value {
...
pub fn grid_widget_from_lua(table: &Table) -> Result<GridWidget, DescriptorError> {
    Ok(GridWidget {
        gap: spacing_value_from_lua(table, "gap")?,
        padding: spacing_value_from_lua(table, "padding")?,
        align: parse_align(&get_required_string_lua(table, "align")?)?,
...
pub fn spacer_widget_from_lua(table: &Table) -> Result<SpacerWidget, DescriptorError> {
    Ok(SpacerWidget {
...
pub fn button_widget_from_lua(table: &Table) -> Result<ButtonWidget, DescriptorError> {
    let label = get_optional_string_lua(table, "label")?;
...
/// JS path).
pub fn announce_widget_from_lua(table: &Table) -> Result<AnnounceWidget, DescriptorError> {
...
pub fn children_from_lua(table: &Table) -> Result<Vec<Widget>, DescriptorError> {
