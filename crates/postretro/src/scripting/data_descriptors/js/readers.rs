...
pub(crate) fn get_required_string_js<'js>(
    obj: &Object<'js>,
    field: &'static str,
...
pub(crate) fn get_optional_bool_js<'js>(
    obj: &Object<'js>,
    field: &'static str,
...
pub(crate) fn get_optional_f32_js<'js>(
    obj: &Object<'js>,
    field: &'static str,
...
pub(crate) fn get_required_f32_js<'js>(
    obj: &Object<'js>,
    field: &'static str,
...
pub(crate) trait FromJsValueRequired: Sized {
